...
export default function ReportDetails() {
  ...
  const reportDate = report.createdAt ? format(new Date(report.createdAt), "PPP") : "N/A";
  const reportTime = report.createdAt ? format(new Date(report.createdAt), "p") : "";
    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-12">
      ...
      <div id="fir-print-area" style={{ display: "none" }}>
        <div className="print-header">
          <h1>Cyber Crime Complaint (FIR)</h1>
          <p>CyberDesk — AI-Powered Incident Reporting Platform</p>
        </div>
        <div className="print-meta">
          <span><strong>Report ID:</strong> #{report.id}</span>
          <span><strong>Incident Type:</strong> {structured?.incidentType}</span>
          <span><strong>Date Filed:</strong> {reportDate} {reportTime}</span>
        </div>
        <div className="print-body">
          {structured?.description || report.rawDescription}
        </div>
        <div className="print-footer">
          Generated by CyberDesk — For official use. Submit to the nearest Cyber Crime Police Station or at cybercrime.gov.in
        </div>
      </div>
